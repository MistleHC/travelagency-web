package com.gmail.mistle.ibo.travelagency.config.hibernate;

import com.gmail.mistle.ibo.travelagency.exceptions.JdbcDriverClassNotFoundException;
...
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            myDataSource.setDriverClass(environment.getProperty("spring.datasource.driver"));
        } catch (PropertyVetoException e) {
            throw new JdbcDriverClassNotFoundException();
        }
        myDataSource.setJdbcUrl(environment.getProperty("spring.datasource.url"));
        myDataSource.setUser(environment.getProperty("spring.datasource.username"));
        myDataSource.setPassword(environment.getProperty("spring.datasource.password"));
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.gmail.mistle.ibo.travelagency.model");
